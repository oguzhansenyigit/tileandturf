...
(1, 'SYNTHETIC TURF SYSTEMS', 'Access the latest technical data sheet (TDS) and catalog for our Synthetic Turf Systems. Download the PDFs for detailed product specifications and installation guidelines.', '/syntethic-turf after 1.webp', '/syn-tds.pdf', '/syn-catalog.pdf', 'from-green-500 to-emerald-600', '🌱', 1, 'active'),
(2, 'IPE TILE SYSTEMS', 'IPE (Brazilian Walnut) is renowned for its dense, hard-wearing nature and natural resistance to moisture, insects, and decay—making it an ideal choice for outdoor decking projects, rooftop terraces, patios, and commercial applications.', '/ipe tile after.webp', '/ipe-tile-tech-sheet.pdf', NULL, 'from-amber-600 to-orange-700', '🪵', 2, 'active'),
(3, 'ADJUSTABLE PEDESTAL SYSTEMS', 'Access comprehensive technical documentation for our Adjustable Pedestal Systems, engineered to provide flexible and durable support for raised flooring applications.', '/adjustable-pedestal-mainpage.webp', '/pedestal-2 (1).pdf', NULL, 'from-blue-500 to-indigo-600', '🔧', 3, 'active'),
(4, 'PORCELAIN PAVERS SYSTEMS', 'Find detailed technical specifications and catalog, performance data, and installation guidelines for our porcelain pavers. Download the latest Technical Data Sheets and catalogs to ensure proper handling, application, and maintenance of your products.', '/porcelain-paver2.webp', '/Porcelain-Paver-TDS-1.pdf', '/porcelain-paver-katalog.pdf', 'from-gray-600 to-slate-700', '🏗️', 4, 'active'),
(5, 'GREEN ROOF SYSTEMS', 'Green Roof Systems are sustainable roofing solutions that combine vegetation, drainage, and structural support to create functional green spaces on rooftops. They improve thermal insulation, reduce stormwater runoff, and enhance building energy efficiency.', '/greenroof-mainpage.webp', '/READY-TO-INSTALL-TRAY-TECHNICAL-DATA-SHEET.pdf', '/greenroof.pdf', 'from-teal-500 to-cyan-600', '🌿', 5, 'active');
