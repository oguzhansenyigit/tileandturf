...
$alterations = [
    "ALTER TABLE products ADD COLUMN IF NOT EXISTS meta_title VARCHAR(255) NULL",
    "ALTER TABLE products ADD COLUMN IF NOT EXISTS meta_description TEXT NULL",
    "ALTER TABLE products ADD COLUMN IF NOT EXISTS meta_keywords VARCHAR(500) NULL"
];
...
if ($success) {
    echo json_encode(['success' => true, 'message' => 'SEO fields added successfully']);
} else {
